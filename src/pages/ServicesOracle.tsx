...
const ServicesOracle = () => {
  const [activeService, setActiveService] = useState<string>('implementation');
  const [activeTab, setActiveTab] = useState<string>('overview');

  const oracleServices: OracleService[] = [
    {
      id: 'implementation',
    ...
    {
      id: 'support',
      title: 'Oracle ERP Support & Maintenance',
      subtitle: '24/7 Expert Support Services',
      description: 'Comprehensive support and maintenance services for your Oracle ERP systems, including proactive monitoring, troubleshooting, and continuous optimization.',
      icon: '🛠️',
      modules: [
      ...
      targetIndustries: ['All Oracle ERP Users', 'Mission-Critical Operations'],
      methodologySteps: [
      ...
      pricing: {
        startingPrice: 'SAR 15,000/month',
        factors: ['System complexity', 'User count', 'SLA requirements', 'Response time needs']
      },
      successMetrics: [
    ...
    {
      id: 'optimization',
      title: 'Oracle ERP Optimization & Consulting',
      subtitle: 'Maximize Your Oracle Investment',
      description: 'Comprehensive optimization services to enhance your existing Oracle ERP performance, streamline processes, and maximize return on investment.',
      icon: '📈',
      modules: [
      ...
      timeline: '2-6 months',
      targetIndustries: ['Existing Oracle Users', 'Performance-Critical Operations'],
      methodologySteps: [
      ...
      pricing: {
        startingPrice: 'SAR 50,000',
        factors: ['System size', 'Optimization scope', 'Custom development', 'Training requirements']
      },
      successMetrics: [
  ...
  const currentService = oracleServices.find(service => service.id === activeService) || oracleServices[0];
